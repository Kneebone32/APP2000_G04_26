...
export const GpxParser = ({ onKoordinaterLastet }) => {
  ...
  return (
    <div className="gpx-filopplasting">
      <label className="gpx-filopplasting-label">{t("gpx.last_opp")}</label>
      <div>
        <input type="file" accept=".gpx" onChange={handleFileChange} className="gpx-filopplasting-input" aria-label="last opp GPX fil" />
      </div>
    </div>
  );
};
