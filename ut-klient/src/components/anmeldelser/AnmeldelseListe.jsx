...
export default function AnmeldelseListe({
  anmeldelser,
  gjennomsnittsrating,
  rating,
  kommentar,
      ...
      <div className="anmeldelse-liste-header">
        ...
        {gjennomsnittsrating && (
          <span className="anmeldelse-gjennomsnitt">
            <span className="anmeldelse-stjerner">★</span> {gjennomsnittsrating}{" "}
            / 5 ({anmeldelser.length})
          </span>
        )}
      </div>
        ...
        anmeldelser.map((anmeldelse) => (
          <div key={anmeldelse.bruker_id} className="anmeldelse-kort">
            <div className="anmeldelse-kort-header">
              ...
              <span className="anmeldelse-stjerner">
                {tegnStjerner(anmeldelse[rating])}
              </span>
            </div>
            {anmeldelse[kommentar] && (
              <p className="anmeldelse-kommentar">{anmeldelse[kommentar]}</p>
            )}
