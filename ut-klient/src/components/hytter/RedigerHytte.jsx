        ...
        const lastHytteData = async () => {
            try {
                ...
                setLagretData({
                    ...
                    koordinat: hytte.koordinater
                        ? [hytte.koordinater.breddegrad, hytte.koordinater.lengdegrad]
                        : null,
                    moh: hytte.koordinater?.moh ?? 0,
                    fasiliteter: hytte.info_tab && hytte.info_tab.length > 0 ? hytte.info_tab : [],
                    bilder: hytte.bilder && hytte.bilder.length > 0
        ...
        <div>
            ...
            {selectedId && !loading && lagretData && (
                <HytteForm
                    ...
                    buttonTekst={t("hytter.oppdater_knapp")}
                />
            )}
        </div>
    );
