  ...
  return (
    <div className="varsel-detaljer">
      <div className="varsel-detaljer-header">
        ...
        <span className="varsel-detaljer-tid">{formatMeldingTid(varsel.opprettet_tidspunkt)}</span>
      </div>
      <p className="varsel-detaljer-innhold">{varsel.innhold}</p>

      {OppgaveType && <OppgaveType varsel={varsel} loading={loading} onBeslutning={handleBeslutning} />}

      <button className="varsel-knapp varsel-knapp-slett" onClick={() => onSlett(varsel.varsel_id)} disabled={loading}>
