...
router.post('/tur', async (req, res) => {
  try {
    const { bruker_id, tur_id, rating, anmeldelse } = req.body;
    ...
    res.json({ message: 'Anmeldelse lagt til' });
  } catch (err) {
    console.error(err);
...
router.post('/hytte', async (req, res) => {
  const { bruker_id, hytte_id, rating, anmeldelse } = req.body;
...
router.delete('/hytte', async (req, res) => {
  const { bruker_id, hytte_id } = req.body;
...
router.post('/turmaal', async (req, res) => {
  const { bruker_id, turmaal_id, rating, anmeldelse } = req.body;
...
router.delete('/turmaal', async (req, res) => {
  const { bruker_id, turmaal_id } = req.body;
